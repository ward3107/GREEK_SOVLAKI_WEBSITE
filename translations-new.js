...
let translations = {
    ...
    'he': {
        ...
        "desc-pita-chicken": "פיתה יוונית, שיפוד עוף, רוטב צזיקי/חריף,  בצל, עגבניה, חסה, צ'יפס",
        "item-pita-pork": "סובלאקי בשר לבן",
        "desc-pita-pork": "פיתה יוונית, שיפוד בשר לבן, רוטב צזיקי/חריף,  בצל, עגבניה, חסה, צ'יפס",
        "item-pita-gyros": "סובלאקי גירוס בשר לבן",
        "desc-pita-gyros": "פיתה יוונית, גירוס בשר לבן (שווארמה), רוטב צזיקי/חריף,  בצל, עגבניה, חסה, צ'יפס",
        "item-pita-kebab": "סובלאקי קבב",
        "desc-pita-kebab": "פיתה יוונית, קבב רגל טלה, רוטב צזיקי/חריף,  בצל, עגבניה, חסה, צ'יפס",
        "item-pita-sausage": "סובלאקי נקניקיה",
        "desc-pita-sausage": "פיתה יוונית, נקניקיות, רוטב צזיקי/חריף,  בצל, עגבניה, חסה, צ'יפס",
        "item-pita-vegan": "סובלאקי טבעוני",
        "desc-pita-vegan": "פיתה יוונית, שיפוד טבעוני, רוטב צזיקי/חריף,  בצל, עגבניה, חסה, צ'יפס",
        "item-pita-steak": "סובלאקי סטייק בשר לבן",
        "desc-pita-steak": "פיתה יוונית, סטייק בשר לבן סינטה, רוטב צזיקי/חריף,  בצל, עגבניה, חסה, צ'יפס",
        "item-pita-glutenfree": "סובלאקי ללא גלוטן",
        "desc-pita-glutenfree": "פיתה ללא גלוטן, שיפוד לבחירה, רוטב צזיקי/חריף,  בצל, עגבניה, חסה, צ'יפס",
        "item-double-skewer": "שיפוד כפול",
        "desc-double-skewer": "תוספת שיפוד נוסף",
        "item-plate-souvlaki": "צלחת סובלאקי",
        "desc-plate-souvlaki": "שיפודים לבחירה, רוטב צזיקי/חריף,  בצל, עגבניה, חסה, צ'יפס",
        "item-plate-gyros": "צלחת סובלאקי גירוס",
        "desc-plate-gyros": "שווארמה בשר לבן, רוטב צזיקי/חריף,  בצל, עגבניה, חסה, צ'יפס",
        "item-platter-two": "מגש בשרים לשניים",
        "desc-platter-two": "3 שיפודים (בשר לבן/עוף/קבב), נקניקה, רוטב מיוחד, 2 סטייק בשר לבן סינטה",
        "item-platter-four": "מגש בשרים לארבעה",
        "desc-platter-four": "6 שיפודים, שווארמה בשר לבן, נקניקה, רוטב מיוחד, 3 סטייק בשר לבן סינטה",
        "item-pizza-small": "פיצה גירוס (קטנה)",
        "desc-pizza-small": "פיצה עם שווארמה בשר לבן וצ'יפס",
        "item-pizza-large": "פיצה גירוס (גדולה)",
        "desc-pizza-large": "פיצה עם שווארמה בשר לבן וצ'יפס",
        ...
        "meta-description": "מסעדה יוונית אותנטית בכפר יאסיף. סובלאקי, גירוס ומטעמים יווניים מסורתיים עם חומרי גלם טריים ואווירה חמה. פתוח רביעי-שבת 13:00-01:00.",
        "meta-title": "סובלאקי יווני - כפר יאסיף | מסעדה יוונית אותנטית",
        "faq-title": "שאלות נפוצות",
        "faq-q1": "מה שעות הפעילות של המסעדה?",
        "faq-a1": "המסעדה פתוחה בימים רביעי עד שבת, בין השעות 13:00 עד 01:00. ימים ראשון עד שלישי המסעדה סגורה.",
